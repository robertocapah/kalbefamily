package kalbefamily.crm.kalbe.kalbefamily.addons.cropper;//// "Therefore those skilled at the unorthodox
...
import kalbefamily.crm.kalbe.kalbefamily.MainMenu;
...
public final class MainFragment extends Fragment
    ...
    public void updateCurrentCropViewOptions() {
        ...
        ((CropDisplayPicture) getActivity()).setCurrentOptions(options);
    }
...
//                break;
    ...
    public void onAttach(Activity activity) {
        ...
        ((CropDisplayPicture) activity).setCurrentFragment(this);
    }
...
//            Toast.makeText(getActivity(), "Image load successful", Toast.LENGTH_SHORT).show();
    ...
    private void handleCropResult(CropImageView.CropResult result) {
        ...
        if (result.getError() == null) {
            ...
            clsDisplayPicture tDisplayPictureData = new clsDisplayPicture();
            tDisplayPictureData.setId(1);
            tDisplayPictureData.setImage(pht);
//            tDisplayPictureData.set_intPush("1");

//            List<tDisplayPictureData> dtList = new ArrayList<>();
//            dtList.add(tDisplayPictureData);
            repoDisplayPicture = new clsDisplayPictureRepo(getActivity());

            new clsActivity().showCustomToast(getContext(), "Saved", true);
